                            ...
                            {product.shopee_url && (
                                <a href={product.shopee_url} target="_blank" className={styles.shopeeBtn}>
                                    <svg viewBox="0 0 100 100" className={styles.shopeeLogo}>
                                        ...
                                        <path d="M48.7 58.7c-3.1 0-5.6-1.3-7.7-3.8l-2.4 2.8c2.6 3.1 6.2 4.7 10.1 4.7 5.6 0 9.7-3.1 9.7-8.1 0-4.5-2.2-7.2-6.7-8.9-2.1-1.1-3.3-2.3-3.3-4.2 0-2.3 2.1-3.9 5.2-3.9 2.5 0 4.6.9 6.2 2.6l2.3-2.6c-2.1-2.1-5-3.3-8.5-3.3-5.2 0-9.2 3-9.2 7.7 0 4.1 2.3 6.6 6.3 8.5 2.5 1.2 3.6 2.3 3.6 4.3 0 2.4-2.2 4.3-5.5 4.3z" fill="#ee4d2d"/>
                                    </svg>
                                    COMPRAR NA SHOPEE
                                </a>
                            )}
